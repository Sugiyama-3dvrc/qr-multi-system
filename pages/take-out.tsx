...
const takeOutOrders = [
  ...
  { no: 3, invoiceNumber: 'INV003', customerName: '鈴木 三郎', staffName: '高橋 花子', tableNumber: 2, status: '未会計', orderDate: '2024-06-18', amount: '4500円' },
  { no: 4, invoiceNumber: 'INV004', customerName: '佐々木 四郎', staffName: '渡辺 一郎', tableNumber: 4, status: '会計済', orderDate: '2024-06-17', amount: '5500円' },
  { no: 5, invoiceNumber: 'INV005', customerName: '佐藤 五郎', staffName: '伊藤 花子', tableNumber: 1, status: '未会計', orderDate: '2024-06-16', amount: '6000円' },
  { no: 6, invoiceNumber: 'INV006', customerName: '斉藤 六郎', staffName: '山本 一郎', tableNumber: 6, status: '会計済', orderDate: '2024-06-15', amount: '7000円' },
  { no: 7, invoiceNumber: 'INV007', customerName: '中島 七郎', staffName: '中村 花子', tableNumber: 7, status: '未会計', orderDate: '2024-06-14', amount: '8000円' },
  { no: 8, invoiceNumber: 'INV008', customerName: '森田 八郎', staffName: '小林 一郎', tableNumber: 8, status: '会計済', orderDate: '2024-06-13', amount: '9000円' },
  { no: 9, invoiceNumber: 'INV009', customerName: '松本 九郎', staffName: '加藤 花子', tableNumber: 9, status: '未会計', orderDate: '2024-06-12', amount: '10000円' },
  { no: 10, invoiceNumber: 'INV010', customerName: '小川 十郎', staffName: '佐々木 一郎', tableNumber: 10, status: '会計済', orderDate: '2024-06-11', amount: '11000円' },
];
  ...
  return (
    <Box sx={{ display: 'flex' }}>
      ...
      <Box component="main" sx={{ flexGrow: 1, p: 4, backgroundColor: '#f9f9f9', minHeight: '100vh' }}>
        <Typography variant="h4" component="h1" fontWeight="bold" color="primary" mb={4}>テイクアウトリスト</Typography>
